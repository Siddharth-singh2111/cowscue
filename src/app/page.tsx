    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative py-20 md:py-32 px-4 overflow-hidden bg-brand-50">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
            <Link href="/report">
              <Button size="lg" className="bg-gray-600 hover:bg-black text-white text-lg px-8 py-7 rounded shadow-xl hover:shadow-2xl transition-all w-full sm:w-auto">
                <Camera className="mr-2 h-6 w-6" /> Report a Cow
              </Button>
            </Link>
            <Link href="#how-it-works">
              <Button variant="outline" size="lg" className="text-lg px-8 py-7 rounded hover:bg-yellow-500  border-2 w-full sm:w-auto">
                How it Works
              </Button>
            </Link>
          </div>
      ...
      <section className="bg-gray-200 text-white py-12">
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          ...
          <div>
            <div className="text-4xl font-bold text-blue-500">10km</div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            ...
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <p className="text-slate-500">
                Nearby registered NGOs receive an alert and dispatch a vehicle immediately.
              </p>
            </div>
          </div>
        </div>
